...
export const alt =
  "Widhi Damar Anandito — Data & Analytics. Turning raw data into decisions with SQL, Python, and BI tools.";
    ...
    (
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          ...
          >
            Data &amp; Analytics — turning raw data into decisions with SQL,
            Python, and BI tools.
          </div>
          <div
            style={{
